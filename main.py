...
host_list=[]
Devices=[] #lista donde se encuentran los dispositivos
sending = [] # lista donde se encuentra los host que estan enviando informacion en la red
stopsend = [] #lista donde se encuentran los host que quieren enviar
...
#metodo create, donde se crean los dispositivos
